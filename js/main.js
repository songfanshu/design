...
// Load the preserved site logic after the laboratory section and research preview
// have been normalized, so all existing page switching/navigation continues to work.
const script=document.createElement('script');
script.src='js/main-original.js?v=research-direct-poster-1';
script.async=false;
