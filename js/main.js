...
@media (min-width:651px){
 ...
 body.paged #home .lab-cn{font-size:clamp(28px,min(2.35vw,4.1vh),40px);line-height:1.32;letter-spacing:.02em;margin:0 0 8px}
...
@media (min-width:651px) and (max-height:700px){
 ...
 body.paged #home .lab-cn{font-size:clamp(25px,4.4vh,34px)}
